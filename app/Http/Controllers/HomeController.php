...
class HomeController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $email = "trackyourtrain12@gmail.com";
        $password = "adminpass";
        $role = "ROLE_ADMIN";
        ...
        if (!User::where("email", $email)->first()) {
            ...
            $userInstance->sendEmailVerificationNotification();
        }
    }
    ...
    public function storePassenger(Request $request)
    {
        ...
        return redirect()->route("dashboard")->with("success", "Registered successfully, Welcome.");
    }
