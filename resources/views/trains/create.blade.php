                                ...
                                <div class="col-md-12">
                                        <div class="form-group{{ $errors->has('trainNumber') ? ' has-danger' : '' }}">
                                            ...
                                            <div class="input-group input-group-alternative mb-3">
                                                <input class="form-control{{ $errors->has('trainNumber') ? ' is-invalid' : '' }}" type="number" name="trainNumber" value="{{ old('trainNumber') }}" required autofocus>
                                            </div>
                            ...
                            <div class="row">
                                    <div class="col-md-12">
                                            <div class="form-group{{ $errors->has('maximumLoad') ? ' has-danger' : '' }}">
                                                ...
                                                <div class="input-group input-group-alternative mb-3">
                                                    <input class="form-control{{ $errors->has('maximumLoad') ? ' is-invalid' : '' }}" type="number" name="maximumLoad" value="{{ old('maximumLoad') }}" required autofocus>
                                                </div>
