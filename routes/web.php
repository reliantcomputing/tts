...
Route::get('/voucher/card', 'VoucherCardController@index')->name("voucherCard");

Route::get('/voucher/card/load/{id}', 'VoucherCardController@load')->name("loadVoucherCard");
Route::post('/voucher/card/generate/{id}', 'VoucherCardController@generate')->name("generateVoucherCard");


Route::get('/voucher/card/load', 'VoucherCardController@load')->name("loadCard");
Route::post('/voucher/load/money', 'VoucherCardController@cardMoney')->name("saveCardMoney"); 
Route::get('/print/ticket/{id}', 'TicketController@generateTicket')->name("printTicket");
Route::get('/print/all/tickets', 'TicketController@printTickets')->name("printTickets");
Route::get('/track', 'TrainController@track')->name("track");
